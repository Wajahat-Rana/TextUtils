...
export default function textBox(props) {
  ...
  return (
    ...
    <div className="mb-3" >
    <label htmlFor="inputText" className="form-label my-3"><h2 style={{color : props.mode==='dark'?'white':'black'}}>Enter Text Below</h2></label>
    <textarea className="form-control" style={{backgroundColor : props.mode==='dark'?'gray':'white',color : props.mode==='dark'?'white':'black'}} value={text} id="inputText" rows="5" onChange={handleChange}></textarea>
    <div>    
